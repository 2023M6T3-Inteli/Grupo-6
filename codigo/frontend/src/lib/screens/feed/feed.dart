        ...
        child: Column(
          ...
          children: [
            ...
            children: [ Container(
              ...
              width: 111,
              height: 28,
              decoration:  BoxDecoration(borderRadius: BorderRadius.circular(5), color: const Color.fromARGB(255, 18, 130, 214)),
              child: Padding(
                ...
                child: 
                  DropdownButton<String>(
                    ...
                    items: <String>['Filter', 'Filter 1', 'Filter 2', 'Filter 3']
            ...
            Container(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  child: const Row(
                    children: [
                      Icon(Icons.close_rounded, color: Colors.blue, size: 20,),
                      Text(
                        "Python",
                        style: TextStyle(
            ...
            Center(
              child: Column(children: [postCardBuilder(),postCardBuilder(),postCardBuilder()],)
            ),
